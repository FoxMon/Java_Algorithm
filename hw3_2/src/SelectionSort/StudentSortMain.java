...
// 2020-04-01
// 학생의 이름 정보를 오름차순으로 정렬하는 클래스를 이용하여 클래스 안의 기능들을 테스트 해보기
...
public class StudentSortMain {
	public static void main(String[] args) {
		...
		System.out.println("hw3_2 : 201635006 컴퓨터공학과 김준호");
		...
		StuSelectionSort.selectsort(student); // 선택정렬 수행
		
		for(int i = 0 ; i < total; i++) { // 선택정렬 결과 출력
