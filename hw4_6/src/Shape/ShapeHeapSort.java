...
// 2020-04-09
// 2020-04-14 힙정렬 완성
// 도형들을 오름차순으로 힙정렬을 수행해 보도록 하자.

public class ShapeHeapSort { // 도형 배열 클래스 구현
	public static void main(String[] args) {
		...
		System.out.println("힙정렬 결과 " + total + "개의 도형 정보와 면적 = "); // 도형의 정보 출력
		ShapeSort.heapSort(shapeArr, total); // 병합정렬 수행
